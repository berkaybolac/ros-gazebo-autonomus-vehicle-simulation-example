...
path = str(os.path.dirname(__file__)) + "/myData"
labelFile = str(os.path.dirname(__file__)) + "/labels.csv"
...
pickle_out = open("mtrained.p", "wb")  # wb = WRITE BYTE
pickle.dump(model, pickle_out, protocol=2)
pickle_out.close()
cv2.waitKey(0)
